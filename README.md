...
За 5 лет коммерческой разработки участвовал в создании и развитии сложных frontend-систем в продуктовых командах ДомКлика и Lamoda. Работал в Scrum-процессах с плотным взаимодействием между фронтендом, бэкендом, аналитиками, дизайнерами и QA.
Регулярно участвовал в планированиях, декомпозиции задач, оценках и проработке требований. Запускал фичи с нуля, поддерживал существующий функционал и занимался техническими улучшениями: оптимизацией интерфейсов, упрощением архитектуры, настройкой тестирования и снижением техдолга.
Помогал развивать команду: ревьюил PR, участвовал в обсуждении архитектуры, проводил онбординг новых разработчиков и готовил документацию.
Отличаюсь ответственностью, внимательностью к деталям и ориентацией на продукт — думаю как о текущей задаче, так и о её поддерживаемости и влиянии на пользователей.
